...
from products.models import Product, ProductGroups
from references.models import Currencies, Categories
...
class CartRules(models.Model):
    ...
    minimum_ammount_currency_id = models.ForeignKey(Currencies, on_delete=models.DO_NOTHING, related_name="minimum_ammount_currency_id")
...
class CartRulesCategories(models.Model):
    cart_rule = models.ForeignKey(CartRules, on_delete=models.DO_NOTHING)
    category = models.ForeignKey(Categories, on_delete=models.DO_NOTHING)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)

class CartRulesProducts(models.Model):
    cart_rule = models.ForeignKey(CartRules, on_delete=models.DO_NOTHING)
    product = models.ForeignKey(Product, on_delete=models.DO_NOTHING)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)

class CartRulesProductsGroups(models.Model):
    cart_rule = models.ForeignKey(CartRules, on_delete=models.DO_NOTHING)
    product_group = models.ForeignKey(ProductGroups, on_delete=models.DO_NOTHING)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)

class CartRulesCombinations(models.Model):
    cart_rule_id1 = models.ForeignKey(CartRules, on_delete=models.DO_NOTHING, related_name="cart_rule_id1")
    cart_rule_id2 = models.ForeignKey(CartRules, on_delete=models.DO_NOTHING, related_name="cart_rule_id2")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
